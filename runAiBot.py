...
def login_LN() -> None:
    ...
    * If both failed, asks user to login manually
    ...
    if username == "username@example.com" and password == "example_password":
            print_lg("ERROR: Username and password not configured in secrets.py! Please update them.")
...
def apply_filters() -> None:
    ...
    try:
        ...
        if pause_after_filters:
            pause_after_filters = False  # Auto-continue in automated mode
                        ...
                        try: 
                            try:
                                ...
                                while next_button:
                                    ...
                                    if next_counter >= 15: 
                                        if pause_at_failed_question:
                                            ...
                                            print_lg("Couldn't answer one or more questions - skipping pause (automated mode)")
                                            next_counter = 1
                                            continue
                                ...
                                if errored != "stuck" and cur_pause_before_submit:
                                    # Auto-continue in automated mode (pause_before_submit = False)
                                    pass
                                ...
                                if wait_span_click(driver, "Submit application", 2, scrollTop=True): 
                                    ...
                                    print_lg("Failed to find Submit Application button - discarding job")
...
def main() -> None:
    # Sponsoring alert removed - running in automated mode
    total_runs = 1
    try:
        ...
        if not os.path.exists(default_resume_path):
            print_lg(f'WARNING: Default resume "{default_resume_path}" is missing! Bot will use previously uploaded LinkedIn resume.')
            useNewResume = False
